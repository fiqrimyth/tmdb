...
class Search with ChangeNotifier {
  ...
  Future<void> searchTVShows(String query, int page) async {
    final url =
        '$BASE_URL/search/tv?api_key=$API_KEY}&language=en-US&query=$query&page=$page&include_adult=false';
  ...
  Future<void> searchPerson(String query, int page) async {
    final url =
        '$BASE_URL/search/person?api_key=$API_KEY&language=en-US&query=$query&$page=1&include_adult=false';
